...
mkdir -p <repo>/site/vendor/pmtiles
cp package/dist/pmtiles.js <repo>/site/vendor/pmtiles/pmtiles.js
...
Run: `cd <repo> && node --test 'dev/tests/*.test.mjs'`
...
Run it: `cd <repo> && pipeline/.venv/bin/python dev/site-json.py --region europe --snapshot 2026-08-19`
